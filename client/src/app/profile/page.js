    ...
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)]">
        ...
        <div className="max-w-lg mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-1.5 rounded-lg text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--card-border)]/50 transition-all"
            >
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          {stats.map((stat) => (
            <div key={stat.label} className="rounded-2xl bg-[var(--card-bg)] border border-[var(--card-border)] p-4 text-center">
              <div className="text-xl mb-1">{stat.icon}</div>
              <p className="text-lg font-bold">{stat.value}</p>
              <p className="text-[10px] text-[var(--text-secondary)] uppercase tracking-wider mt-0.5">{stat.label}</p>
            </div>
          ))}
        </div>
      ...
      {showLogoutConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-sm rounded-2xl bg-[var(--card-bg)] border border-[var(--card-border)] p-6 shadow-2xl text-center">
            {/* Warning Icon */}
